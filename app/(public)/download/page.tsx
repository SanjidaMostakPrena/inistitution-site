...
const DOWNLOAD_DATA = {
  ...
  categories: [
    { id: "all", label: "সব ডাউনলোড", icon: <Download className="h-4 w-4" />, color: "from-green-500 to-green-700", count: 0 },
    { id: "forms", label: "ভর্তি ফর্ম", icon: <FileText className="h-4 w-4" />, color: "from-blue-500 to-blue-700", count: 0 },
    { id: "prospectus", label: "প্রসপেক্টাস", icon: <BookOpen className="h-4 w-4" />, color: "from-green-500 to-green-700", count: 0 },
    { id: "calendar", label: "একাডেমিক ক্যালেন্ডার", icon: <Calendar className="h-4 w-4" />, color: "from-purple-500 to-purple-700", count: 0 },
    { id: "routine", label: "ক্লাস রুটিন", icon: <Clock className="h-4 w-4" />, color: "from-orange-500 to-orange-700", count: 0 },
    { id: "exam", label: "পরীক্ষার রুটিন", icon: <File className="h-4 w-4" />, color: "from-red-500 to-red-700", count: 0 },
    { id: "syllabus", label: "সিলেবাস", icon: <BookMarked className="h-4 w-4" />, color: "from-indigo-500 to-indigo-700", count: 0 },
    { id: "notices", label: "নোটিশ", icon: <Megaphone className="h-4 w-4" />, color: "from-yellow-500 to-yellow-700", count: 0 },
    { id: "results", label: "ফলাফল পিডিএফ", icon: <Award className="h-4 w-4" />, color: "from-pink-500 to-pink-700", count: 0 },
  ],
  items: [
    {
      id: 1,
