      ...
      <div className="mb-8">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            ...
            <p className="text-gray-500 mt-1">সকল ভর্তি আবেদন দেখুন ও পরিচালনা করুন</p>
          </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
        <div className="bg-white p-5 rounded-2xl shadow-sm border border-gray-100 hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
          <div className="flex items-center justify-between">
            <div><p className="text-sm text-gray-500 font-medium">মোট আবেদন</p><p className="text-2xl font-bold text-slate-800 mt-1">{total}</p></div>
            <div className="p-3 bg-blue-50 rounded-xl"><FileText className="h-6 w-6 text-blue-600" /></div>
          </div>
        </div>
        <div className="bg-white p-5 rounded-2xl shadow-sm border border-gray-100 hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
          <div className="flex items-center justify-between">
            <div><p className="text-sm text-gray-500 font-medium">বিচারাধীন</p><p className="text-2xl font-bold text-yellow-600 mt-1">{pending}</p></div>
            <div className="p-3 bg-yellow-50 rounded-xl"><Clock className="h-6 w-6 text-yellow-600" /></div>
          </div>
        </div>
        <div className="bg-white p-5 rounded-2xl shadow-sm border border-gray-100 hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
          <div className="flex items-center justify-between">
            <div><p className="text-sm text-gray-500 font-medium">অ্যাপ্রুভড</p><p className="text-2xl font-bold text-green-600 mt-1">{approved}</p></div>
            <div className="p-3 bg-green-50 rounded-xl"><UserCheck className="h-6 w-6 text-green-600" /></div>
          </div>
        </div>
        <div className="bg-white p-5 rounded-2xl shadow-sm border border-gray-100 hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
          <div className="flex items-center justify-between">
            <div><p className="text-sm text-gray-500 font-medium">রিজেক্টেড</p><p className="text-2xl font-bold text-red-600 mt-1">{rejected}</p></div>
            <div className="p-3 bg-red-50 rounded-xl"><UserX className="h-6 w-6 text-red-600" /></div>
          </div>
        </div>
      </div>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="bg-gray-50 border-b border-gray-200">
                ...
                <th className="px-4 py-3 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">আবেদনের তারিখ</th>
                <th className="px-4 py-3 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">স্ট্যাটাস</th>
                ...
                <tr>
                  <td colSpan={5} className="px-4 py-12 text-center text-gray-500">
                    <div className="flex flex-col items-center">
                      ...
                      <p className="text-xs text-gray-400 mt-1">নতুন আবেদন এলে এখানে দেখাবে</p>
                    </div>
                  </td>
                </tr>
              ) : (
                filteredApps.map((app) => (
                  <tr key={app.id} className="hover:bg-green-50/50 transition-colors duration-200 group">
                    <td className="px-4 py-3">
                      <div className="flex items-center gap-3">
                        <div className="w-8 h-8 rounded-full bg-gradient-to-br from-green-100 to-green-200 flex items-center justify-center text-green-700 font-semibold text-xs">
                    ...
                    <td className="px-4 py-3 text-slate-700">{app.classApplying}</td>
                    ...
                    <td className="px-4 py-3">
                      <div className="flex items-center justify-center gap-1.5">
                        <button
                          ...
                          className="p-1.5 bg-blue-50 text-blue-600 rounded-lg hover:bg-blue-100 transition-all duration-300 hover:scale-110"
                        ...
                        {app.status === "pending" && (
                          <>
                            ...
                            <button
                              ...
                              className="p-1.5 bg-red-50 text-red-600 rounded-lg hover:bg-red-100 transition-all duration-300 hover:scale-110"
                              title="রিজেক্ট করুন"
                            >
                        ...
                        {app.status !== "pending" && (
                          <button
                            ...
                            className="p-1.5 bg-gray-50 text-gray-600 rounded-lg hover:bg-gray-100 transition-all duration-300 hover:scale-110"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-4">
                <div className="bg-gray-50 p-4 rounded-xl">
                  <h4 className="font-semibold text-slate-800 text-sm mb-3">ব্যক্তিগত তথ্য</h4>
                  <div className="space-y-2 text-sm">
                    <p><span className="text-gray-500">নাম:</span> <span className="font-medium">{selectedApp.studentName}</span></p>
                    <p><span className="text-gray-500">জন্ম তারিখ:</span> {selectedApp.dateOfBirth}</p>
                    <p><span className="text-gray-500">শ্রেণী:</span> {selectedApp.classApplying}</p>
                    <p><span className="text-gray-500">পূর্ববর্তী প্রতিষ্ঠান:</span> {selectedApp.previousInstitution || "—"}</p>
                  </div>
                </div>

                <div className="bg-gray-50 p-4 rounded-xl">
                  <h4 className="font-semibold text-slate-800 text-sm mb-3">অভিভাবকের তথ্য</h4>
                  <div className="space-y-2 text-sm">
                    <p><span className="text-gray-500">পিতা:</span> {selectedApp.fatherName}</p>
                    <p><span className="text-gray-500">মাতা:</span> {selectedApp.motherName}</p>
                    <p><span className="text-gray-500">যোগাযোগ:</span> {selectedApp.guardianContact}</p>
                    <p><span className="text-gray-500">ইমেইল:</span> {selectedApp.email}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div className="bg-gray-50 p-4 rounded-xl">
                  <h4 className="font-semibold text-slate-800 text-sm mb-3">ঠিকানা</h4>
                  <p className="text-sm text-gray-700">{selectedApp.address}</p>
                </div>

                <div className="bg-gray-50 p-4 rounded-xl">
                  <h4 className="font-semibold text-slate-800 text-sm mb-3">ছবি</h4>
                  {selectedApp.photograph ? (
                    ...
                    <p className="text-sm text-gray-500">কোন ছবি আপলোড করা হয়নি</p>
                  )}
                </div>

                <div className="bg-gray-50 p-4 rounded-xl">
                  <h4 className="font-semibold text-slate-800 text-sm mb-3">স্ট্যাটাস</h4>
                  ...
                  <p className="text-xs text-gray-400 mt-2">আবেদনের তারিখ: {formatDate(selectedApp.submittedAt)}</p>
                </div>
              </div>
            </div>
